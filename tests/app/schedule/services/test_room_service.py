...
def test_create_room_success(room_service: BaseRoomService):
    room = RoomModelFactory.build()
...
@pytest.mark.django_db
def test_create_room_already_exists_failure(room_service: BaseRoomService):
    room = RoomModelFactory.create()
...
@pytest.mark.django_db
def test_get_count_room_exist(room_service: BaseRoomService):
    expected_count = 5
    RoomModelFactory.create_batch(size=expected_count)
...
@pytest.mark.django_db
def test_get_all_rooms_success(room_service: BaseRoomService):
    expected_count = 5
    rooms = RoomModelFactory.create_batch(size=expected_count)
...
@pytest.mark.django_db
def test_get_list_rooms_success(room_service: BaseRoomService):
    expected_count = 5
    rooms = RoomModelFactory.create_batch(size=expected_count)
    room_numbers = {room.number for room in rooms}
...
@pytest.mark.django_db
def test_get_by_uuid_room_success(room_service: BaseRoomService):
    room = RoomModelFactory.create()
...
@pytest.mark.django_db
def test_get_by_uuid_room_not_found_failure(room_service: BaseRoomService):
    room = RoomModelFactory.build()
...
@pytest.mark.django_db
def test_get_by_id_room_success(room_service: BaseRoomService):
    room = RoomModelFactory.create()
...
@pytest.mark.django_db
def test_get_by_id_room_not_found_failure(room_service: BaseRoomService):
    room = RoomModelFactory.build()
...
@pytest.mark.django_db
def test_check_exists_by_number_room_true(room_service: BaseRoomService):
    room = RoomModelFactory.create()
...
@pytest.mark.django_db
def test_check_exists_by_number_room_false(room_service: BaseRoomService):
    room = RoomModelFactory.build()
...
@pytest.mark.django_db
def test_update_room_number_success(room_service: BaseRoomService):
    room = RoomModelFactory.create()

    new_room = RoomModelFactory.build()

    assert room_service.update_number(room_id=room.id, number=new_room.number) is None


@pytest.mark.django_db
def test_update_room_name_failure(room_service: BaseRoomService):
    room = RoomModelFactory.build()
...
@pytest.mark.django_db
def test_update_room_description_success(room_service: BaseRoomService):
    room = RoomModelFactory.create()
...
@pytest.mark.django_db
def test_update_room_description_failure(room_service: BaseRoomService):
    room = RoomModelFactory.build()
...
@pytest.mark.django_db
def test_delete_room_success(room_service: BaseRoomService):
    room = RoomModelFactory.create()
...
@pytest.mark.django_db
def test_delete_room_failure(room_service: BaseRoomService):
    room = RoomModelFactory.build()
