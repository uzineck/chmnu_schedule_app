    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                'indexes': [models.Index(fields=['faculty_uuid'], name='schedule_fa_faculty_9afcb2_idx'), models.Index(fields=['code_name'], name='schedule_fa_code_na_4a5e39_idx')],
            },
        ),
        migrations.CreateModel(
            name='Group',
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                'indexes': [models.Index(fields=['room_uuid'], name='schedule_ro_room_uu_26c111_idx'), models.Index(fields=['number'], name='schedule_ro_number_93d1aa_idx')],
            },
        ),
        migrations.AddField(
            model_name='lesson',
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                'indexes': [models.Index(fields=['subject_uuid'], name='schedule_su_subject_61a2c8_idx'), models.Index(fields=['title'], name='schedule_su_title_da8e99_idx')],
            },
        ),
        migrations.AddField(
            model_name='lesson',
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                'indexes': [models.Index(fields=['teacher_uuid'], name='schedule_te_teacher_e34185_idx')],
            },
        ),
        migrations.AddField(
            model_name='lesson',
        ...
        migrations.AddIndex(
            model_name='group',
            index=models.Index(fields=['group_uuid'], name='schedule_gr_group_u_b0567f_idx'),
        ),
        migrations.AddIndex(
            model_name='group',
            index=models.Index(fields=['number'], name='schedule_gr_number_104152_idx'),
        ),
        migrations.AddIndex(
            model_name='lesson',
            index=models.Index(fields=['lesson_uuid'], name='schedule_le_lesson__895969_idx'),
        ),
    ]
