    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description', models.CharField(blank=True, max_length=300, verbose_name='Description of the room')),
            ],
            options={
                'verbose_name': 'Room',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sophomore', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='group_sophomore', to='clients.sophomore', verbose_name='Sophomore of the group')),
        ...
        migrations.AddField(
            model_name='lesson',
            name='room',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='lesson_room', to='schedule.room', verbose_name='Room where the lesson is held'),
        ),
        migrations.AddField(
            model_name='lesson',
            name='subject',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='lesson_subject', to='schedule.subject', verbose_name='Subject of the lesson'),
        ),
        migrations.CreateModel(
            name='Teacher',
            fields=[
        ...
        migrations.AddField(
            model_name='lesson',
            name='teacher',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='lesson_teacher', to='schedule.teacher', verbose_name='Teacher that holds the lesson'),
        ),
        migrations.AddField(
            model_name='lesson',
            name='timeslot',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='lesson_timeslot', to='schedule.timeslot', verbose_name='Timeslot when the lesson is held'),
        ),
    ]
