...
from core.api.v1.schedule.sophomores.schemas import SignUpInSchema, SignUpOutSchema, LogInOutSchema, LogInSchema, \
    UpdateEmailInSchema, UpdateEmailOutSchema, UpdatePwInSchema, UpdatePwOutSchema
from core.api.v1.schedule.sophomores.containers import sophomore_auth, sophomore_service, sophomore_update
